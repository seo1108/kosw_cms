...
<div class="text-center">
	<ul class="pagination">
		...
		<li class="page-first ${firstClass}"><a href="javascript:setPage(1);">«</a></li>
		<li class="page-before ${beforeClass}"><a href="javascript:setPage(${pageNavigation.beforePage });">«</a></li>
		<c:forEach var="p" begin="${pageNavigation.startPage}" end="${pageNavigation.endPage}">
			...
			<li class="${currentClass }"><a href="javascript:setPage(${p});">${p}</a></li>
		</c:forEach>
		<li class="page-next ${nextClass}"><a href="javascript:setPage(${pageNavigation.nextPage });">›</a></li>
		<li class="page-last ${lastClass}"><a href="javascript:setPage(${pageNavigation.totalPage });">››</a></li>
	</ul>
</div>
