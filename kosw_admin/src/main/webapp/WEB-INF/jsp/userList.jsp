								...
								<table class="table">
									...
									<c:forEach var="a" items="${userList }">
										<tr>
											...
											<td>	
												<form name="userApprovalEdit" action="<c:url value="/userApprovalEdit"/>" method="post">
											...
											<td>
												<form class="deleteForm" method="post" action="<c:url value="userMapDelete"/>" style="display:inline-block;">
